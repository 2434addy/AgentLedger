      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center"
        ...
        <div className="relative z-10 text-center px-12">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-white mb-3">Join AgentLedger</h1>
            <p className="text-white/50 text-lg leading-relaxed max-w-xs mx-auto">
              Start monitoring your AI agents in minutes. Free forever. No credit card required.
            </p>
            <div className="mt-10 space-y-3">
              {[
                'Full audit trail for every agent',
          ...
          <div className="glass-card p-8">
            <div className="mb-8">
              ...
              <p className="text-white/50">
                An organisation will be created automatically for you.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" suppressHydrationWarning>
              <div>
                ...
                <p className="text-white/30 text-xs mt-1">
                  Your org will be created as &quot;{displayName ? `${displayName}'s Org` : "Your Name's Org"}&quot;
                </p>
              </div>
              <div>
